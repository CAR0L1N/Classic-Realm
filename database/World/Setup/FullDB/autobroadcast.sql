...
INSERT INTO `autobroadcast` (`id`, `content`, `ratio`) VALUES (1,'|cff00ff00This is a sample of an automatic server message. You can use |cffffffffcolor tags |cff00ff00also|r',1),(2,'|cff00ffffThis is a sample of an automatic server message. You can use |cffffffffcolor tags also|r',1),(3,'This is a sample of an automatic server message.',3);
